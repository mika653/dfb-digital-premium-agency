...
export const DiscoveryCallModal: React.FC<DiscoveryCallModalProps> = ({ isOpen, onClose, prefillMessage }) => {
  const [formData, setFormData] = useState({ name: '', email: '', phone: '', message: prefillMessage || '' });
  ...
  // Reset message when prefillMessage changes (new service selected)
  React.useEffect(() => {
