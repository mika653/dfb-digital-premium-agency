      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="order-2 lg:order-1">
            ...
            <button className="mt-12 group flex items-center justify-between gap-10 px-6 py-4 border border-brand-blue text-brand-blue font-bold text-xs uppercase tracking-widest rounded-full hover:bg-brand-blue hover:text-white smooth-transition">
