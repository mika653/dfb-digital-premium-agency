                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-4">
                      ...
                      <a
                        ...
                        className="inline-flex items-center gap-3 px-6 py-4 border-2 border-black/10 text-black font-bold text-xs uppercase tracking-widest rounded-full hover:border-[#0A66C2] hover:text-[#0A66C2] smooth-transition"
                      >
